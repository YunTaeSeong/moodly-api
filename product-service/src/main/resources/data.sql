...
INSERT IGNORE INTO products (name, price, discount, image, description, details, category_id, sub_category_id, created_by, created_date) VALUES
('남성 캐주얼 데님 트러커 재킷', 89000.00, 30, 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=500&h=500&fit=crop', 
...
('남성 스트레이트 핏 청바지', 89000.00, 28, 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=500&h=500&fit=crop', 
'다리가 곧게 떨어지는 남성 스트레이트 핏 데님입니다.', 
'• 중간 워싱·진청·블랙\n• 신축 데님 옵션\n• 28~38인치', 
1, 1, 'system', NOW()),

('남성 오버핏 맨투맨', 52000.00, 35, 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=500&h=500&fit=crop', 
...
('여성 플레어 미디 원피스', 89000.00, 42, 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=500&h=500&fit=crop', 
'밑단이 퍼지는 플레어 실루엣의 여성 미디 원피스입니다.', 
'• 허리 밴딩·끈 옵션\n• 안감 포함(일부 컬러)\n• 데일리·모임 겸용', 
1, 2, 'system', NOW()),

('여성 새틴 브이넥 블라우스', 72000.00, 45, 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=500&h=500&fit=crop', 
'은은한 광택의 여성 브이넥 블라우스입니다.', 
'• 오피스·데이트 룩\n• 비침 완화 이너 추천\n• 드라이클리닝 권장', 
1, 2, 'system', NOW()),

('여성 울 혼방 H라인 미디 스커트', 68000.00, 38, 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=500&h=500&fit=crop', 
'세로 라인이 깔끔한 여성 H라인 미디 스커트입니다.', 
'• 뒷트임·히든 밴딩\n• 사계절 두께 선택\n• 블라우스·니트와 매치', 
1, 2, 'system', NOW()),

('여성 오버사이즈 라운드 니트', 78000.00, 32, 'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=500&h=500&fit=crop', 
'여유 있는 핏의 여성 오버사이즈 니트입니다.', 
'• 부드러운 편직\n• 팔꿈치 박음 강화\n• 레깅스·스키니진과 코디', 
1, 2, 'system', NOW()),

('여성 하이웨스트 스키니 데님', 84000.00, 50, 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=500&h=500&fit=crop', 
'허리를 안정적으로 잡아주는 여성 하이웨스트 스키니 청바지입니다.', 
'• 스트레치 데님\n• 9부·롱 기장\n• 워싱 다양', 
1, 2, 'system', NOW()),

('여성 크롭 박시 스웨트셔츠', 48000.00, 48, 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=500&h=500&fit=crop', 
...
('키즈 스트라이프 티 & 멜빵 반바지 세트', 48000.00, 40, 'https://images.unsplash.com/photo-1511895426328-dc8714191300?w=500&h=500&fit=crop', 
...
('키즈 경량 후드 윈드브레이커', 59000.00, 44, 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=500&h=500&fit=crop', 
